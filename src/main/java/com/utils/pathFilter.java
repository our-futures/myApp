...
public class pathFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if(requestPath.indexOf("/user/loginPage")>=0 || requestPath.indexOf("/user/login")>=0 || requestPath.indexOf("/user/regPage")>=0 || 
				requestPath.indexOf("/user/register")>=0 || requestPath.indexOf("/menu/load")>=0 ){ //登录页面,注册页面不拦截
